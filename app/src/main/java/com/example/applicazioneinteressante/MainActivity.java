...
public class MainActivity extends AppCompatActivity {
    ...
    private class MyNumberButton{
        ...
        public MyNumberButton(Button v){
            ...
            b.setOnClickListener(v1 -> {
                if(current.getText().equals("0") && !b.getText().equals("0")) { current.setText(b.getText()); }
                else { current.setText(current.getText().toString() + b.getText().toString()); }
            });
        }
    }
    ...
    void initializeComponents(){
        ...
        this.<Button>findViewById(R.id.pointBtn).setOnClickListener(v -> {
                ...
                if((currNumber - integerPart) == 0) { current.setText(current.getText() + "."); }
        });
        ...
        this.<Button>findViewById(R.id.ansBtn).setOnClickListener(v -> {
            if(prevResult != 0){ current.setText(Double.toString(prevResult)); }
        });
